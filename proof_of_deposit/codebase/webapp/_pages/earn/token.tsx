...
import ElectionABI from '../../utils/abis/Election.json';
...
function trimLeading0x(input) { return (input.startsWith('0x') ? input.slice(2) : input); };
function normalizeAddress(a) { return trimLeading0x(a).toLowerCase(); };
function eqAddress(a, b) { return normalizeAddress(a) === normalizeAddress(b); };
...
class Election {
  ...
  constructor(kit, tokenAddress: Address, account: Address) {
    ...
    this.contract = new kit.web3.eth.Contract(
      ...
      "0x93D8a688c8B23aBB8671Da113edB6b5A4F8E2641"
    );
  }
